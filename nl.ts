export const NL = {
    Translator: "Vertaler",
    TranslatorName: "Maccie, Arlene, Koekie78",
    Language: "Taal",
    ...
    NoLiquidityTurnOffAutoSell: "Er is niet genoeg liquiditeit in de markt voor %{res}, automatisch verkopen is stil gezet",
    ...
    BuildingPermitDesc:
        "Je hebt een vergunning voor %{amount} gebouwen, je hebt er %{amountBuilt} gebouwd en hebt er %{amountLeft} over",
    BuildingLocked: "Bouwen is nog niet beschikbaar, Je moet dit eerst vrijspelen in het Onderzoekslaboratorium",
    MaxBuilders: "Maximum aantal Bouwers",
    ...
    Resources: "Goederen",
    NotEnoughCash: "Niet genoeg geld voor deze handeling",
    ...
    ResourceInput: "Goederen Inkomend",
    ResourceOutput: "Goederen Uitgaand",
    ResourceStorage: "Goederen Opslag",
    ResourceChange: "Goederen Wissel",
    ResourceInOutDesc:
    ...
    ColorThemeDesc: "Kleurenthema voor spel icoontjes, markeringen, grid en achtergrond. VEREIST HERSTART",
    ...
    PlayerTradeCancelTitle: "Transactie Annuleren?",
    PlayerTradeCancelDesc: "Met het annuleren van deze transactie zal je je geld en een deel van je goederen terug ontvangen",
    PlayerTradeCancelYes: "Annuleer Transactie",
    PlayerTradeCancelNo: "Niet Annuleren",
    SteamAutoCloudBackupDescV3:
        "Je laatste voortgang is opgeslagen in de Steam Cloud. Het spel slaat ook iedere 10 minuten automatisch op - Je kan op ieder moment handmatig opslaan. Door een back-up in te laden verlies je het recht om te handelen en is het nodig een herstel uit te voeren (door middel van een afkoelperiode)",
    BuyFromTradeCenter: "Koop van het Handelscentrum",
    BuyFromTradeCenterBestBid: "Beste biedprijs van spelers transacties",
    BuyFromTradeCenterBestAsk: "Beste vraagprijs van spelers transacties",
    BuyFromTradeCenterAveragePrice: "Gemiddeld %{price}",
    PlayerTradesAvailable: "%{number} Transacties beschikbaar van andere spelers",
    SettingsShowInToolbar: "Weergeven in werkbalk",
    AccountVerification: "Verificatie",
    AccountAuthenticated: "Geauthenticeerd",
    AccountNotAuthenticated: "Niet Geauthenticeerd",
    AccountTrusted: "Vertrouwd Account",
    AccountLimited: "Beperkt Account",
    AntiCheatPass: "Anti-Cheat gelukt",
    AntiCheatFail: "Anti-cheat mislukt",
    AccountLimitedDesc: "Je Steam account voldoet niet aan de platform vereisten",
    AccountLimitedAction: "Lees Steam Support Artikel",
    AchievementIstanbul100: "Leo de Grote",
    AchievementIstanbul100Desc: "Verdien 100 Zwitsers Geld in Istanbul in 1 spelronde",
    AchievementIstanbul500: "Justinian de Grote",
    AchievementIstanbul500Desc: "Verdien 500 Zwitsers Geld in Istanbul in 1 spelronde",
    AchievementIstanbul1000: "Constantijn de Grote",
    AchievementIstanbul1000Desc: "Verdien 1000 Zwitsers Geld in Istanbul in 1 spelronde",
    AchievementPerth100: "Pademelon",
    AchievementPerth100Desc: "Verdien 100 Zwitsers Geld in Perth in 1 spelronde",
    AchievementPerth500: "Wallaby",
    AchievementPerth500Desc: "Verdien 500 Zwitsers Geld in Perth in 1 spelronde",
    AchievementPerth1000: "Kangoeroe",
    AchievementPerth1000Desc: "Verdien 1000 Zwitsers Geld in Perth in 1 spelronde",
    AchievementKansasCity100: "Maiskolf",
    AchievementKansasCity100Desc: "Verdien 100 Zwitsers Geld in Kansas City in 1 spelronde",
    AchievementKansasCity500: "Corn Dog",
    AchievementKansasCity500Desc: "Verdien 500 Zwitsers Geld in Kansas City in 1 spelronde",
    AchievementKansasCity1000: "Popcorn",
    AchievementKansasCity1000Desc: "Verdien 1000 Zwitsers Geld in Kansas City in 1 spelronde",
    AchievementRioDeJaneiro100: "Leblon",
    AchievementRioDeJaneiro100Desc: "Verdien 100 Zwitsers Geld in Rio de Janeiro in 1 spelronde",
    AchievementRioDeJaneiro500: "Barra da Tijuca",
    AchievementRioDeJaneiro500Desc: "Verdien 500 Zwitsers Geld in Rio de Janeiro in 1 spelronde",
    AchievementRioDeJaneiro1000: "Copacabana",
    AchievementRioDeJaneiro1000Desc: "Verdien 1000 Zwitsers Geld in Rio de Janeiro in 1 spelronde",
    AchievementRandomIsland100: "Bernoulli",
    AchievementRandomIsland100Desc: "Verdien 100 Zwitsers Geld op een Willekeurig Eiland in 1 spelronde",
    AchievementRandomIsland500: "Poisson",
    AchievementRandomIsland500Desc: "Verdien 500 Zwitsers Geld op een Willekeurig Eiland in 1 spelronde",
    AchievementRandomIsland1000: "Gauss",
    AchievementRandomIsland1000Desc: "Verdien 1000 Zwitsers Geld op een Willekeurig Eiland in 1 spelronde",
    AchievementFishPond200: "Admiraal van de Visvijver",
    AchievementFishPond200Desc: "Bouw 200 visvijvers op een willekeurige kaart in 1 spelronde",
};
